...
public final class CodecUtils {
    ...
    public static void main(String[] args) {
		String key = "lenovo-tripnote-com";
		String source = "1";
		String envalue = CodecUtils.desEncryp(source,key);
		String otherValue = CodecUtils.desDecrypt(envalue,key);
    ...
    static {
        ...
        try {
            ...
            log.error("DES默认加密解密初始化失败：" + e.getMessage(), e);
